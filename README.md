...
Mini projet - Agent autonome qui transforme une question en requête SQL, l'exécute sur une base SQLite locale et s'auto-corrige en cas d'erreur avant de renvoyer une réponse synthétique.
